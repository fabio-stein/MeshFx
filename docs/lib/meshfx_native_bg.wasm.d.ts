...
export function set_native_handler(a: number): void;
export function process_message(a: number, b: number, c: number, d: number): void;
export function initialize(): void;
export function process_web_message(a: number, b: number, c: number, d: number): void;
export function __wbg_nativewebbuffer_free(a: number): void;
export function __wbg_get_nativewebbuffer_ptr(a: number): number;
export function __wbg_set_nativewebbuffer_ptr(a: number, b: number): void;
export function __wbg_get_nativewebbuffer_size(a: number): number;
export function __wbg_set_nativewebbuffer_size(a: number, b: number): void;
...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfef8dbbcebe99a56(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1bd8c853cd06eb45(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h865d5049e25d6369(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h2ed5b8d4126b4c43(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__he5a8086e6184a37a(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h231a3b031e04b070(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h46a26a8cdb528e95(a: number, b: number, c: number): void;
